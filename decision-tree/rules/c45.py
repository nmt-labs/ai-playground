...
def findDecision(obj): #obj[0]: HistoriaDoCredito, obj[1]: Divida, obj[2]: Garantias, obj[3]: RendaAnual
	# {"feature": "RendaAnual", "instances": 14, "metric_value": 1.5306, "depth": 1}
	if obj[3] == '>35000':
		# {"feature": "HistoriaDoCredito", "instances": 7, "metric_value": 1.1488, "depth": 2}
		...
		if obj[1] == 'Alta':
			# {"feature": "HistoriaDoCredito", "instances": 3, "metric_value": 0.9183, "depth": 3}
			if obj[0] == 'Desconhecida':
				return 'Alto'
			elif obj[0] == 'Boa':
				return 'Moderado'
