# Altere a codificação dos atributos (preço, cliente e tempo de espera) para um
# atributo nominal não ordinal e faça os experimentos acima novamente. 
...
# better tree :D
previsores = ['Alguns', 'Cheio', 'Nenhum', 'R', 'RR', 'RRR','Frances', 'Hamburguer', 'Italiano', 'Tailandes', '0-10', '10-30', '30-60', '>60', 'Alternativo', 'Bar', 'SextaSabado', 'Fome', 'Cliente', 'Preco','Chuva','Res','Tipo', 'Tempo']
